...
export default function UserDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-sans">
      <h1 className="text-3xl font-serif font-bold text-brand-green mb-8">My Trips</h1>
      
      {bookings.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-xl border border-gray-200">
          <p className="text-gray-500 font-sans">No bookings yet.</p>
        </div>
      ) : (
            ...
            <div key={booking.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-grow">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-xl font-serif font-semibold text-gray-900">{booking.title}</h3>
                    <p className="text-gray-500 font-sans">{booking.location}</p>
                  </div>
                  <span className={`px-3 py-1 rounded-full text-xs font-medium font-sans ${
                    booking.status === 'confirmed' ? 'bg-brand-green/10 text-brand-green' : 
                ...
                <div className="mt-4 grid grid-cols-2 gap-4 text-sm text-gray-600 font-sans">
                  <div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center font-sans">
